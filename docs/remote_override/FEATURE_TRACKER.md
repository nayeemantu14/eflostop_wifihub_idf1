...
override_active/remaining, T10 (reboot persistence, informal), **TC-N10 FULLY PASSED (2026-06-24, fw 1.4.1 —
leak_reset refused while wet; valve_set_state:"open" rejected at the hub with no valve_state_changed transient;
dry recovery opens)**. REMAINING: T7 (button↔app parity), optional T11 (no-network reboot), T12 (shortened-expiry).
